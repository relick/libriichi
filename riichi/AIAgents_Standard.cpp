...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
TurnDecisionData GhostAgent::MakeTurnDecision
(
...
//------------------------------------------------------------------------------
BetweenTurnsDecisionData GhostAgent::MakeBetweenTurnsDecision
(
	DecisionToken i_token,
	AIRNG& io_rng,
	Seat i_agentSeat,
...
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
TurnDecisionData ButtonMasherAgent::MakeTurnDecision
(
	DecisionToken i_token,
	AIRNG& io_rng,
	Seat i_agentSeat,
...
//------------------------------------------------------------------------------
BetweenTurnsDecisionData ButtonMasherAgent::MakeBetweenTurnsDecision
(
	DecisionToken i_token,
	AIRNG& io_rng,
	Seat i_agentSeat,
